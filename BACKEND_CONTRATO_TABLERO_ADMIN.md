...
Para integración frontend/backend de Admin, el documento único vigente es:

- `src/docs/GUIA_CANONICA_FRONTEND_BACKEND_ADMIN.md`

Si hay diferencias con otras guías históricas, prevalece este documento canónico.
