...
### Opcion de compatibilidad temporal

Si el frontend todavia usa aliases, puede enviar lo mismo en mas de un campo durante la transicion.
...
Pero si ya estas usando `asignadoA`, no es necesario repetir la lista tres veces.
