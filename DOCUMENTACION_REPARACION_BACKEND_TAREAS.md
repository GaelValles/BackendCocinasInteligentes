...
El backend guarda todos los IDs que lleguen en la lista canónica `asignadoA` y no la reduce a un solo valor. Si el formulario manda varios responsables, se persisten todos.
...
Archivo: [src/app/admin/operaciones/page.tsx](src/app/admin/operaciones/page.tsx)
